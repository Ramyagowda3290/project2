...
a persistence unit "art1PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "art1/pom.xml":
...
artifact ("art1.war") is already built. You can build
